"""
Django settings for systemize project.
...
SECRET_KEY = '0axm(md6a%+0*y1u1rto#po-ox9o8lwe1ged@s4*q-^@-%dh-v'
...
WSGI_APPLICATION = 'systemize.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('PG_DB_PASS', 'postgres'),
        'HOST': os.environ.get('PG_DB_HOST', 'postgres'),
